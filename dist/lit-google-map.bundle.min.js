...
/**
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */,ct={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:C},pt=(t=ct,e,i)=>{const{kind:s,metadata:o}=i;let r=globalThis.litPropertyMetadata.get(o);if(void 0===r&&globalThis.litPropertyMetadata.set(o,r=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const o=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,o,t)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const o=this[s];e.call(this,i),this.requestUpdate(s,o,t)}}throw Error("Unsupported decorator location: "+s)};function dt(t){return(e,i)=>"object"==typeof i?pt(t,e,i):((t,e,i)=>{const s=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}t.LitGoogleMap=class extends at{constructor(){super(...arguments),this.apiKey="",this.version="3.48",this.styles=[],this.zoom=8,this.fitToMarkers=!1,this.mapType="roadmap",this.centerLatitude=-34.397,this.centerLongitude=150.644,this.language="",this.mapId="DEMO_MAP_ID",this.colorScheme="",this.map=null,this.markers=[],this.shapes=[],this.controls=[],this.markerObserverSet=!1}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),this.map&&e!==i&&null!==i&&("center-latitude"===t||"center-longitude"===t?this.map.setCenter({lat:this.centerLatitude,lng:this.centerLongitude}):"zoom"===t?this.map.setZoom(this.zoom):"color-scheme"===t&&this.colorScheme&&this.map.setOptions({colorScheme:this.colorScheme}))}dispatchViewChanged(){var t,e,i;this.dispatchEvent(new CustomEvent("view_changed",{detail:{center:null===(e=null===(t=this.map)||void 0===t?void 0:t.getCenter())||void 0===e?void 0:e.toJSON(),zoom:null===(i=this.map)||void 0===i?void 0:i.getZoom()},bubbles:!0,composed:!0}))}initGMap(){var t,e;if(null!=this.map)return;const i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("api");null!=i&&!0===i.libraryLoaded&&(this.map=new google.maps.Map(null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("map"),this.getMapOptions()),this.map.addListener("bounds_changed",(()=>{var t,e;this.dispatchEvent(new CustomEvent("bounds_changed",{detail:null===(e=null===(t=this.map)||void 0===t?void 0:t.getBounds())||void 0===e?void 0:e.toJSON(),bubbles:!0,composed:!0}))})),this.map.addListener("tilesloaded",(()=>{var t,e;this.dispatchEvent(new CustomEvent("tilesloaded",{detail:null===(e=null===(t=this.map)||void 0===t?void 0:t.getBounds())||void 0===e?void 0:e.toJSON(),bubbles:!0,composed:!0}))})),this.map.addListener("center_changed",(()=>{var t,e;this.dispatchEvent(new CustomEvent("center_changed",{detail:null===(e=null===(t=this.map)||void 0===t?void 0:t.getCenter())||void 0===e?void 0:e.toJSON(),bubbles:!0,composed:!0})),this.dispatchViewChanged()})),this.map.addListener("zoom_changed",(()=>{var t;this.dispatchEvent(new CustomEvent("zoom_changed",{detail:{zoom:null===(t=this.map)||void 0===t?void 0:t.getZoom()},bubbles:!0,composed:!0})),this.dispatchViewChanged()})),this.map.addListener("click",(t=>{"placeId"in t&&(t.stop(),this.dispatchEvent(new CustomEvent("place_click",{detail:{placeId:t.placeId},bubbles:!0,composed:!0})))})),this.updateMarkers(),this.updateShapes(),this.updateControls())}getMapOptions(){return Object.assign({zoom:this.zoom,center:{lat:this.centerLatitude,lng:this.centerLongitude},mapTypeId:this.mapType,styles:this.styles,mapId:this.mapId},this.colorScheme&&{colorScheme:this.colorScheme})}mapApiLoaded(){this.initGMap()}connectedCallback(){super.connectedCallback(),this.initGMap()}updated(t){super.updated(t),this.map?((t.has("centerLatitude")||t.has("centerLongitude"))&&(t.get("centerLatitude"),t.get("centerLongitude"),this.map.setCenter({lat:this.centerLatitude,lng:this.centerLongitude})),t.has("zoom")&&(t.get("zoom"),this.map.setZoom(this.zoom))):console.log("Map not initialized yet, skipping update")}attachChildrenToMap(t){if(this.map)for(const e of t)e.changeMap(this.map)}detachChildrenFromMap(t){if(this.map)for(const e of t)e.changeMap(null)}observeMarkers(){this.markerObserverSet||(this.addEventListener("selector-items-changed",(()=>{this.updateMarkers()})),this.markerObserverSet=!0)}updateMarkers(){var t,e;this.observeMarkers();const i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("markers-selector");if(!i)return;const s=i.items;if(this.markers&&s.length===this.markers.length){const t=s.filter((t=>this.markers&&-1===this.markers.indexOf(t)));if(0===t.length)return}const o=this.checkBoundsChanged(this.markers,s),r=(null===(e=this.markers)||void 0===e?void 0:e.filter((t=>-1===s.indexOf(t))))||[];this.detachChildrenFromMap(r),this.markers=s,this.attachChildrenToMap(this.markers),this.fitToMarkers&&o&&this.fitToMarkersChanged()}updateShapes(){var t;if(!this.map)return;const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("shapes-selector");if(e){this.shapes=e.items;for(const t of this.shapes)t.attachToMap(this.map)}}updateControls(){var t;if(!this.map)return;const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("controls-selector");if(e){this.controls=e.items;for(const t of this.controls)t.changeMap(this.map)}}fitToMarkersChanged(t=0){if(this.map&&this.fitToMarkers&&this.markers.length>0){const e=new google.maps.LatLngBounds;for(const t of this.markers)e.extend(new google.maps.LatLng(t.latitude,t.longitude));const i=this.getBoundingClientRect();if(0===i.width||0===i.height){console.log("Invalid DOM width or height for lit-google-map");return void setTimeout((()=>{this.fitToMarkersChanged(t+1)}),2**t*100)}this.markers.length>1&&this.map.fitBounds(e,0),this.map.setCenter(e.getCenter())}}checkBoundsChanged(t,e){const i=e.filter((e=>!(null==t?void 0:t.includes(e)))),s=null==t?void 0:t.filter((t=>!(null==e?void 0:e.includes(t))));return i.length>0||s.length>0}deselectMarker(t){}deselectShape(t){}render(){return D`
      <lit-google-maps-api
        id="api"
        api-key="${this.apiKey}"
