var LitGoogleMap = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  class JsonpLibraryElement extends r$1 {
      constructor() {
          super(...arguments);
  ...
  exports.LitGoogleMapMarker = class LitGoogleMapMarker extends r$1 {
      constructor() {
          super(...arguments);
          this.latitude = 0;
          this.longitude = 0;
  ...
  exports.LitGoogleMapCircle = class LitGoogleMapCircle extends r$1 {
      constructor() {
          super(...arguments);
  ...
  exports.LitGoogleMapPolygon = class LitGoogleMapPolygon extends r$1 {
      constructor() {
          super(...arguments);
          this.paths = [];
          this.fillColor = "#FF0000";
  ...
  exports.LitGoogleMap = class LitGoogleMap extends r$1 {
      constructor() {
          super(...arguments);
          this.apiKey = "";
          this.version = "3.48";
  ...
  exports.LitSelector = class LitSelector extends r$1 {
      constructor() {
          super(...arguments);
